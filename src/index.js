...
class Shape extends Component {
  ...
  render() {
    ...
    return <div ref={this.progressBar} className={`progressbar-container ${container_class}`} style={this.props.container_style}></div>
  }
}

const Circle = (props) => <Shape type='circle' container_class={props.container_class} options={props.options} {...props} />

const SemiCircle = (props) => <Shape type='semicircle' container_class={props.container_class} options={props.options} {...props} />

const Line = (props) => <Shape type='line' container_class={props.container_class} options={props.options} {...props} />
